...
public class ConsumerLoanControllerTests extends TestBase{
	...
	@Test
	public void consumerLoanPerfectBorrowerShouldHaveRiskFactor_0() throws Exception {
	...
	@Test
	public void consumerLoanDelinquentBorrowerShouldHaveRiskFactor_035() throws Exception {
		Borrower borrower = new Borrower();
		borrower.setName("James Gosling");
		borrower.setAnnualIncome((double) 10000);
	...
	@Test
	public void consumerLoanNoCreditHistoryBorrowerShouldHaveRiskFactor_025() throws Exception {
		Borrower borrower = new Borrower();
		borrower.setName("James Gosling");
		borrower.setAnnualIncome((double) 10000);
		borrower.setDelinquentDebt(false);
	...
	@Test
	public void consumerLoanTooMuchDebtBorrowerShouldHaveRiskFactor_040() throws Exception {
		Borrower borrower = new Borrower();
		borrower.setName("James Gosling");
		borrower.setAnnualIncome((double) 10000);
		borrower.setDelinquentDebt(false);
	...
	@Test
	public void consumerLoanNoIncomeBorrowerShouldHaveRiskFactor_040() throws Exception {
		Borrower borrower = new Borrower();
		borrower.setName("James Gosling");
	...
	@Test
	public void consumerLoanTooMuchDebtAndDelinquentBorrowerShouldHaveRiskFactor_075() throws Exception {
		Borrower borrower = new Borrower();
		borrower.setName("James Gosling");
		borrower.setAnnualIncome((double) 10000);
		borrower.setDelinquentDebt(true);
	...
	@Test
	public void consumerLoanTerribleBorrowerShouldHaveRiskFactor_1() throws Exception {
		Borrower borrower = new Borrower();
		borrower.setName("James Gosling");
		borrower.setAnnualIncome((double) 10000);
		borrower.setDelinquentDebt(true);
